package org.gps.collect.android.instrumented.tasks;
...
import org.gps.collect.android.openrosa.OpenRosaConstants;
...
import org.gps.collect.android.support.MockedServerTest;
import org.gps.collect.android.tasks.InstanceServerUploaderTask;
import org.gps.collect.android.tasks.InstanceUploaderTask;
...
import static org.gps.collect.android.support.TestUtils.assertMatches;
import static org.gps.collect.android.support.TestUtils.cleanUpTempFiles;
import static org.gps.collect.android.support.TestUtils.createTempFile;
import static org.gps.collect.android.support.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.gps.collect.android/.* Dalvik/.*", r.getHeader("User-Agent"));

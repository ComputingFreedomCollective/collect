...
import static org.gps.collect.android.database.DatabaseConstants.INSTANCES_TABLE_NAME;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.CAN_EDIT_WHEN_COMPLETE;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.DELETED_DATE;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.DISPLAY_NAME;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.GEOMETRY_TYPE;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.INSTANCE_FILE_PATH;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.JR_FORM_ID;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.JR_VERSION;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.LAST_STATUS_CHANGE_DATE;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.STATUS;
import static org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns.SUBMISSION_URI;
...
public class InstanceDatabaseMigrator implements DatabaseMigrator {
     ...
     * column which was redundant with the {@link org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns#STATUS} and
     * {@link org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns#LAST_STATUS_CHANGE_DATE} columns and included

...
import org.gps.collect.android.BuildConfig;
import org.gps.collect.android.R;
import org.gps.collect.android.analytics.Analytics;
import org.gps.collect.android.analytics.FirebaseAnalytics;
import org.gps.collect.android.application.AppStateProvider;
import org.gps.collect.android.application.CollectSettingsChangeHandler;
import org.gps.collect.android.application.initialization.ApplicationInitializer;
import org.gps.collect.android.application.initialization.CollectSettingsPreferenceMigrator;
import org.gps.collect.android.application.initialization.SettingsPreferenceMigrator;
import org.gps.collect.android.backgroundwork.ChangeLock;
...
import org.gps.collect.android.backgroundwork.ReentrantLockChangeLock;
import org.gps.collect.android.backgroundwork.SchedulerFormUpdateAndSubmitManager;
...
import org.gps.collect.android.configure.SharedPreferencesServerRepository;
import org.gps.collect.android.configure.StructureAndTypeSettingsValidator;
import org.gps.collect.android.configure.qr.CachingQRCodeGenerator;
import org.gps.collect.android.configure.qr.QRCodeDecoder;
import org.gps.collect.android.configure.qr.QRCodeGenerator;
import org.gps.collect.android.configure.qr.QRCodeUtils;
import org.gps.collect.android.dao.FormsDao;
import org.gps.collect.android.dao.InstancesDao;
import org.gps.collect.android.database.DatabaseFormsRepository;
import org.gps.collect.android.database.DatabaseInstancesRepository;
import org.gps.collect.android.database.DatabaseMediaFileRepository;
...
import org.gps.collect.android.formentry.media.AudioHelperFactory;
import org.gps.collect.android.formentry.media.ScreenContextAudioHelperFactory;
import org.gps.collect.android.formentry.saving.DiskFormSaver;
import org.gps.collect.android.formentry.saving.FormSaveViewModel;
import org.gps.collect.android.formmanagement.DiskFormsSynchronizer;
import org.gps.collect.android.formmanagement.FormDownloader;
import org.gps.collect.android.formmanagement.FormMetadataParser;
import org.gps.collect.android.formmanagement.ServerFormDownloader;
...
import org.gps.collect.android.forms.FormSource;
import org.gps.collect.android.forms.FormsRepository;
import org.gps.collect.android.forms.MediaFileRepository;
import org.gps.collect.android.gdrive.GoogleAccountCredentialGoogleAccountPicker;
import org.gps.collect.android.gdrive.GoogleAccountPicker;
import org.gps.collect.android.gdrive.GoogleApiProvider;
import org.gps.collect.android.geo.MapProvider;
import org.gps.collect.android.instances.InstancesRepository;
import org.gps.collect.android.logic.PropertyManager;
import org.gps.collect.android.metadata.InstallIDProvider;
import org.gps.collect.android.metadata.SharedPreferencesInstallIDProvider;
import org.gps.collect.android.network.ConnectivityProvider;
import org.gps.collect.android.network.NetworkStateProvider;
import org.gps.collect.android.notifications.NotificationManagerNotifier;
import org.gps.collect.android.notifications.Notifier;
import org.gps.collect.android.openrosa.CollectThenSystemContentTypeMapper;
import org.gps.collect.android.openrosa.OpenRosaFormSource;
import org.gps.collect.android.openrosa.OpenRosaHttpInterface;
import org.gps.collect.android.openrosa.OpenRosaResponseParserImpl;
...
import org.gps.collect.android.preferences.JsonPreferencesGenerator;
...
import org.gps.collect.android.storage.migration.StorageEraser;
import org.gps.collect.android.storage.migration.StorageMigrationRepository;
import org.gps.collect.android.storage.migration.StorageMigrator;
import org.gps.collect.android.utilities.ActivityAvailability;
import org.gps.collect.android.utilities.AdminPasswordProvider;
import org.gps.collect.android.utilities.AndroidUserAgent;
import org.gps.collect.android.utilities.DeviceDetailsProvider;
import org.gps.collect.android.utilities.ExternalAppIntentProvider;
import org.gps.collect.android.utilities.FileProvider;
import org.gps.collect.android.utilities.FileUtil;
import org.gps.collect.android.utilities.FormsDirDiskFormsSynchronizer;
import org.gps.collect.android.utilities.MediaUtils;
import org.gps.collect.android.utilities.ScreenUtils;
import org.gps.collect.android.utilities.SoftKeyboardController;
import org.gps.collect.android.utilities.WebCredentialsUtils;
import org.gps.collect.android.version.VersionInformation;
import org.gps.collect.android.views.BarcodeViewDecoder;
import org.gps.collect.async.CoroutineAndWorkManagerScheduler;
import org.gps.collect.async.Scheduler;
import org.gps.collect.audiorecorder.recording.AudioRecorder;
import org.gps.collect.audiorecorder.recording.AudioRecorderFactory;
import org.gps.collect.utilities.Clock;
import org.gps.collect.utilities.UserAgentProvider;
...
import static org.gps.collect.android.preferences.MetaKeys.KEY_INSTALL_ID;

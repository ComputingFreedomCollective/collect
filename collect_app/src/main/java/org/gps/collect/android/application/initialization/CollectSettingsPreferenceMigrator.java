package org.gps.collect.android.application.initialization;
...
import org.gps.collect.android.application.initialization.migration.KeyRenamer;
import org.gps.collect.android.application.initialization.migration.KeyTranslator;
import org.gps.collect.android.application.initialization.migration.Migration;

import java.util.List;

import static java.util.Arrays.asList;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.combineKeys;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.extractNewKey;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.moveKey;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.removeKey;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.renameKey;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.translateKey;
import static org.gps.collect.android.application.initialization.migration.MigrationUtils.translateValue;
import static org.gps.collect.android.preferences.GeneralKeys.BASEMAP_SOURCE_CARTO;
import static org.gps.collect.android.preferences.GeneralKeys.BASEMAP_SOURCE_OSM;
import static org.gps.collect.android.preferences.GeneralKeys.BASEMAP_SOURCE_STAMEN;
import static org.gps.collect.android.preferences.GeneralKeys.BASEMAP_SOURCE_USGS;
import static org.gps.collect.android.preferences.GeneralKeys.KEY_BASEMAP_SOURCE;
import static org.gps.collect.android.preferences.GeneralKeys.KEY_CARTO_MAP_STYLE;
import static org.gps.collect.android.preferences.GeneralKeys.KEY_GOOGLE_MAP_STYLE;
import static org.gps.collect.android.preferences.GeneralKeys.KEY_MAPBOX_MAP_STYLE;
import static org.gps.collect.android.preferences.GeneralKeys.KEY_USGS_MAP_STYLE;

...
import org.gps.collect.android.formentry.questions.AudioVideoImageTextLabel;
...
import org.gps.collect.android.preferences.GuidanceHint;
import org.gps.collect.android.utilities.AnimationUtils;
...
import org.gps.collect.android.utilities.StringUtils;
import org.gps.collect.android.utilities.ThemeUtils;
import org.gps.collect.android.utilities.ViewUtils;
import org.gps.collect.android.widgets.interfaces.Widget;
import org.gps.collect.android.widgets.items.SelectImageMapWidget;
...
import static org.gps.collect.android.analytics.AnalyticsEvents.PROMPT;
import static org.gps.collect.android.formentry.media.FormMediaUtils.getClipID;
import static org.gps.collect.android.formentry.media.FormMediaUtils.getPlayColor;
import static org.gps.collect.android.formentry.media.FormMediaUtils.getPlayableAudioURI;
...
public abstract class QuestionWidget extends FrameLayout implements Widget {
     ...
     * {@link org.gps.collect.android.utilities.QuestionMediaManager} to access media attached
     * to the instance.
     */
    @Nullable
    @Deprecated

...
package org.gps.collect.android.activities;
...
import org.gps.collect.android.audio.AMRAppender;
import org.gps.collect.android.audio.AudioControllerView;
import org.gps.collect.android.audio.M4AAppender;
import org.gps.collect.android.backgroundwork.FormSubmitManager;
import org.gps.collect.android.dao.FormsDao;
import org.gps.collect.android.dao.helpers.ContentResolverHelper;
import org.gps.collect.android.dao.helpers.FormsDaoHelper;
import org.gps.collect.android.dao.helpers.InstancesDaoHelper;
import org.gps.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.gps.collect.android.events.RxEventBus;
import org.gps.collect.android.exception.JavaRosaException;
...
import org.gps.collect.android.formentry.FormEndView;
import org.gps.collect.android.formentry.FormEntryMenuDelegate;
import org.gps.collect.android.formentry.FormEntryViewModel;
import org.gps.collect.android.formentry.FormIndexAnimationHandler;
import org.gps.collect.android.formentry.FormIndexAnimationHandler.Direction;
import org.gps.collect.android.formentry.FormLoadingDialogFragment;
import org.gps.collect.android.formentry.ODKView;
import org.gps.collect.android.formentry.QuitFormDialogFragment;
import org.gps.collect.android.formentry.RecordingHandler;
import org.gps.collect.android.formentry.RecordingWarningDialogFragment;
import org.gps.collect.android.formentry.audit.AuditEvent;
import org.gps.collect.android.formentry.audit.AuditUtils;
import org.gps.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.gps.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.gps.collect.android.formentry.audit.IdentityPromptViewModel;
import org.gps.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.gps.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.gps.collect.android.formentry.loading.FormInstanceFileCreator;
import org.gps.collect.android.formentry.repeats.AddRepeatDialog;
import org.gps.collect.android.formentry.repeats.DeleteRepeatDialogFragment;
import org.gps.collect.android.formentry.saving.FormSaveViewModel;
import org.gps.collect.android.formentry.saving.SaveAnswerFileErrorDialogFragment;
import org.gps.collect.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
import org.gps.collect.android.formentry.saving.SaveFormProgressDialogFragment;
import org.gps.collect.android.forms.Form;
import org.gps.collect.android.forms.FormDesignException;
import org.gps.collect.android.forms.FormsRepository;
import org.gps.collect.android.fragments.MediaLoadingFragment;
import org.gps.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.gps.collect.android.fragments.dialogs.CustomTimePickerDialog;
import org.gps.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.gps.collect.android.fragments.dialogs.NumberPickerDialog;
import org.gps.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.gps.collect.android.fragments.dialogs.RankingWidgetDialog;
...
import org.gps.collect.android.javarosawrapper.FormController.FailedConstraint;
import org.gps.collect.android.listeners.AdvanceToNextListener;
import org.gps.collect.android.listeners.FormLoaderListener;
import org.gps.collect.android.listeners.PermissionListener;
import org.gps.collect.android.listeners.SavePointListener;
import org.gps.collect.android.listeners.SwipeHandler;
import org.gps.collect.android.listeners.WidgetValueChangedListener;
import org.gps.collect.android.logic.FormInfo;
import org.gps.collect.android.logic.ImmutableDisplayableQuestion;
import org.gps.collect.android.logic.PropertyManager;
import org.gps.collect.android.permissions.PermissionsChecker;
import org.gps.collect.android.preferences.AdminKeys;
import org.gps.collect.android.preferences.AdminSharedPreferences;
import org.gps.collect.android.preferences.GeneralKeys;
...
import org.gps.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.gps.collect.android.provider.InstanceProviderAPI.InstanceColumns;
...
import org.gps.collect.android.tasks.FormLoaderTask;
import org.gps.collect.android.tasks.SaveFormIndexTask;
import org.gps.collect.android.tasks.SavePointTask;
...
import org.gps.collect.android.utilities.DestroyableLifecyleOwner;
import org.gps.collect.android.utilities.DialogUtils;
import org.gps.collect.android.utilities.ExternalAppIntentProvider;
import org.gps.collect.android.utilities.MultiClickGuard;
import org.gps.collect.android.utilities.PlayServicesChecker;
import org.gps.collect.android.utilities.ScreenContext;
import org.gps.collect.android.utilities.SnackbarUtils;
import org.gps.collect.android.utilities.SoftKeyboardController;
import org.gps.collect.android.utilities.ToastUtils;
import org.gps.collect.android.widgets.DateTimeWidget;
import org.gps.collect.android.widgets.QuestionWidget;
import org.gps.collect.android.widgets.RangePickerDecimalWidget;
import org.gps.collect.android.widgets.RangePickerIntegerWidget;
import org.gps.collect.android.widgets.interfaces.WidgetDataReceiver;
import org.gps.collect.android.widgets.utilities.ExternalAppRecordingRequester;
import org.gps.collect.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import org.gps.collect.android.widgets.utilities.InternalRecordingRequester;
import org.gps.collect.android.widgets.utilities.ViewModelAudioPlayer;
import org.gps.collect.android.widgets.utilities.WaitingForDataRegistry;
import org.gps.collect.async.Scheduler;
import org.gps.collect.audioclips.AudioClipViewModel;
...
import static org.gps.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.gps.collect.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static org.gps.collect.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static org.gps.collect.android.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static org.gps.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.gps.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.gps.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.gps.collect.android.utilities.DialogUtils.getDialog;
import static org.gps.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.gps.collect.android.utilities.ToastUtils.showLongToast;
import static org.gps.collect.android.utilities.ToastUtils.showShortToast;

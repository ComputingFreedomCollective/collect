...
package org.gpssurvey.collect.android.activities;
...
import org.gpssurvey.collect.android.audio.AMRAppender;
import org.gpssurvey.collect.android.audio.AudioControllerView;
import org.gpssurvey.collect.android.audio.M4AAppender;
import org.gpssurvey.collect.android.backgroundwork.FormSubmitManager;
import org.gpssurvey.collect.android.dao.FormsDao;
import org.gpssurvey.collect.android.dao.helpers.ContentResolverHelper;
import org.gpssurvey.collect.android.dao.helpers.FormsDaoHelper;
import org.gpssurvey.collect.android.dao.helpers.InstancesDaoHelper;
import org.gpssurvey.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.gpssurvey.collect.android.events.RxEventBus;
import org.gpssurvey.collect.android.exception.JavaRosaException;
import org.gpssurvey.collect.android.formentry.BackgroundAudioPermissionDialogFragment;
import org.gpssurvey.collect.android.formentry.BackgroundAudioViewModel;
import org.gpssurvey.collect.android.formentry.FormEndView;
import org.gpssurvey.collect.android.formentry.FormEntryMenuDelegate;
import org.gpssurvey.collect.android.formentry.FormEntryViewModel;
import org.gpssurvey.collect.android.formentry.FormIndexAnimationHandler;
import org.gpssurvey.collect.android.formentry.FormIndexAnimationHandler.Direction;
import org.gpssurvey.collect.android.formentry.FormLoadingDialogFragment;
...
import org.gpssurvey.collect.android.formentry.RecordingHandler;
import org.gpssurvey.collect.android.formentry.RecordingWarningDialogFragment;
import org.gpssurvey.collect.android.formentry.audit.AuditEvent;
import org.gpssurvey.collect.android.formentry.audit.AuditUtils;
import org.gpssurvey.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.gpssurvey.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
import org.gpssurvey.collect.android.formentry.audit.IdentityPromptViewModel;
import org.gpssurvey.collect.android.formentry.backgroundlocation.BackgroundLocationManager;
import org.gpssurvey.collect.android.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.gpssurvey.collect.android.formentry.loading.FormInstanceFileCreator;
import org.gpssurvey.collect.android.formentry.repeats.AddRepeatDialog;
import org.gpssurvey.collect.android.formentry.repeats.DeleteRepeatDialogFragment;
...
import org.gpssurvey.collect.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
...
import org.gpssurvey.collect.android.forms.FormDesignException;
import org.gpssurvey.collect.android.forms.FormsRepository;
import org.gpssurvey.collect.android.fragments.MediaLoadingFragment;
import org.gpssurvey.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.gpssurvey.collect.android.fragments.dialogs.CustomTimePickerDialog;
import org.gpssurvey.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.gpssurvey.collect.android.fragments.dialogs.NumberPickerDialog;
import org.gpssurvey.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.gpssurvey.collect.android.fragments.dialogs.RankingWidgetDialog;
...
import org.gpssurvey.collect.android.javarosawrapper.FormController.FailedConstraint;
import org.gpssurvey.collect.android.listeners.AdvanceToNextListener;
import org.gpssurvey.collect.android.listeners.FormLoaderListener;
import org.gpssurvey.collect.android.listeners.PermissionListener;
import org.gpssurvey.collect.android.listeners.SavePointListener;
import org.gpssurvey.collect.android.listeners.SwipeHandler;
import org.gpssurvey.collect.android.listeners.WidgetValueChangedListener;
import org.gpssurvey.collect.android.logic.FormInfo;
import org.gpssurvey.collect.android.logic.ImmutableDisplayableQuestion;
...
import org.gpssurvey.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.gpssurvey.collect.android.provider.InstanceProviderAPI.InstanceColumns;
...
import org.gpssurvey.collect.android.tasks.FormLoaderTask;
import org.gpssurvey.collect.android.tasks.SaveFormIndexTask;
import org.gpssurvey.collect.android.tasks.SavePointTask;
import org.gpssurvey.collect.android.utilities.ActivityAvailability;
import org.gpssurvey.collect.android.utilities.ApplicationConstants;
import org.gpssurvey.collect.android.utilities.DestroyableLifecyleOwner;
import org.gpssurvey.collect.android.utilities.DialogUtils;
import org.gpssurvey.collect.android.utilities.ExternalAppIntentProvider;
import org.gpssurvey.collect.android.utilities.MultiClickGuard;
import org.gpssurvey.collect.android.utilities.PlayServicesChecker;
import org.gpssurvey.collect.android.utilities.ScreenContext;
import org.gpssurvey.collect.android.utilities.SnackbarUtils;
import org.gpssurvey.collect.android.utilities.SoftKeyboardController;
import org.gpssurvey.collect.android.utilities.ToastUtils;
import org.gpssurvey.collect.android.widgets.DateTimeWidget;
import org.gpssurvey.collect.android.widgets.QuestionWidget;
import org.gpssurvey.collect.android.widgets.RangePickerDecimalWidget;
import org.gpssurvey.collect.android.widgets.RangePickerIntegerWidget;
import org.gpssurvey.collect.android.widgets.interfaces.WidgetDataReceiver;
import org.gpssurvey.collect.android.widgets.utilities.ExternalAppRecordingRequester;
import org.gpssurvey.collect.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import org.gpssurvey.collect.android.widgets.utilities.InternalRecordingRequester;
import org.gpssurvey.collect.android.widgets.utilities.ViewModelAudioPlayer;
import org.gpssurvey.collect.android.widgets.utilities.WaitingForDataRegistry;
import org.gpssurvey.collect.async.Scheduler;
import org.gpssurvey.collect.audioclips.AudioClipViewModel;
...
import static org.gpssurvey.collect.android.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.gpssurvey.collect.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static org.gpssurvey.collect.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static org.gpssurvey.collect.android.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static org.gpssurvey.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.gpssurvey.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.gpssurvey.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.gpssurvey.collect.android.utilities.DialogUtils.getDialog;
import static org.gpssurvey.collect.android.utilities.DialogUtils.showIfNotShowing;
import static org.gpssurvey.collect.android.utilities.ToastUtils.showLongToast;
import static org.gpssurvey.collect.android.utilities.ToastUtils.showShortToast;

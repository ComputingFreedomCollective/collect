...
import org.gpssurvey.collect.android.analytics.FirebaseAnalytics;
import org.gpssurvey.collect.android.application.AppStateProvider;
import org.gpssurvey.collect.android.application.CollectSettingsChangeHandler;
import org.gpssurvey.collect.android.application.initialization.ApplicationInitializer;
import org.gpssurvey.collect.android.application.initialization.CollectSettingsPreferenceMigrator;
import org.gpssurvey.collect.android.application.initialization.SettingsPreferenceMigrator;
...
import org.gpssurvey.collect.android.backgroundwork.ReentrantLockChangeLock;
import org.gpssurvey.collect.android.backgroundwork.SchedulerFormUpdateAndSubmitManager;
import org.gpssurvey.collect.android.configure.ServerRepository;
import org.gpssurvey.collect.android.configure.SettingsChangeHandler;
import org.gpssurvey.collect.android.configure.SettingsImporter;
import org.gpssurvey.collect.android.configure.SharedPreferencesServerRepository;
import org.gpssurvey.collect.android.configure.StructureAndTypeSettingsValidator;
import org.gpssurvey.collect.android.configure.qr.CachingQRCodeGenerator;
import org.gpssurvey.collect.android.configure.qr.QRCodeDecoder;
import org.gpssurvey.collect.android.configure.qr.QRCodeGenerator;
import org.gpssurvey.collect.android.configure.qr.QRCodeUtils;
import org.gpssurvey.collect.android.dao.FormsDao;
import org.gpssurvey.collect.android.dao.InstancesDao;
import org.gpssurvey.collect.android.database.DatabaseFormsRepository;
import org.gpssurvey.collect.android.database.DatabaseInstancesRepository;
import org.gpssurvey.collect.android.database.DatabaseMediaFileRepository;
...
import org.gpssurvey.collect.android.formentry.media.AudioHelperFactory;
import org.gpssurvey.collect.android.formentry.media.ScreenContextAudioHelperFactory;
import org.gpssurvey.collect.android.formentry.saving.DiskFormSaver;
import org.gpssurvey.collect.android.formentry.saving.FormSaveViewModel;
import org.gpssurvey.collect.android.formmanagement.DiskFormsSynchronizer;
import org.gpssurvey.collect.android.formmanagement.FormDownloader;
import org.gpssurvey.collect.android.formmanagement.FormMetadataParser;
import org.gpssurvey.collect.android.formmanagement.ServerFormDownloader;
...
import org.gpssurvey.collect.android.forms.FormSource;
import org.gpssurvey.collect.android.forms.FormsRepository;
import org.gpssurvey.collect.android.forms.MediaFileRepository;
import org.gpssurvey.collect.android.gdrive.GoogleAccountCredentialGoogleAccountPicker;
...
import org.gpssurvey.collect.android.geo.MapProvider;
...
import org.gpssurvey.collect.android.metadata.InstallIDProvider;
import org.gpssurvey.collect.android.metadata.SharedPreferencesInstallIDProvider;
import org.gpssurvey.collect.android.network.ConnectivityProvider;
import org.gpssurvey.collect.android.network.NetworkStateProvider;
import org.gpssurvey.collect.android.notifications.NotificationManagerNotifier;
import org.gpssurvey.collect.android.notifications.Notifier;
import org.gpssurvey.collect.android.openrosa.CollectThenSystemContentTypeMapper;
import org.gpssurvey.collect.android.openrosa.OpenRosaFormSource;
import org.gpssurvey.collect.android.openrosa.OpenRosaHttpInterface;
import org.gpssurvey.collect.android.openrosa.OpenRosaResponseParserImpl;
import org.gpssurvey.collect.android.openrosa.okhttp.OkHttpConnection;
import org.gpssurvey.collect.android.openrosa.okhttp.OkHttpOpenRosaServerClientProvider;
...
import org.gpssurvey.collect.android.preferences.JsonPreferencesGenerator;
...
import org.gpssurvey.collect.android.storage.migration.StorageEraser;
import org.gpssurvey.collect.android.storage.migration.StorageMigrationRepository;
import org.gpssurvey.collect.android.storage.migration.StorageMigrator;
import org.gpssurvey.collect.android.utilities.ActivityAvailability;
import org.gpssurvey.collect.android.utilities.AdminPasswordProvider;
import org.gpssurvey.collect.android.utilities.AndroidUserAgent;
import org.gpssurvey.collect.android.utilities.DeviceDetailsProvider;
import org.gpssurvey.collect.android.utilities.ExternalAppIntentProvider;
import org.gpssurvey.collect.android.utilities.FileProvider;
import org.gpssurvey.collect.android.utilities.FileUtil;
import org.gpssurvey.collect.android.utilities.FormsDirDiskFormsSynchronizer;
import org.gpssurvey.collect.android.utilities.MediaUtils;
import org.gpssurvey.collect.android.utilities.ScreenUtils;
import org.gpssurvey.collect.android.utilities.SoftKeyboardController;
import org.gpssurvey.collect.android.utilities.WebCredentialsUtils;
import org.gpssurvey.collect.android.version.VersionInformation;
import org.gpssurvey.collect.android.views.BarcodeViewDecoder;
import org.gpssurvey.collect.async.CoroutineAndWorkManagerScheduler;
import org.gpssurvey.collect.async.Scheduler;
import org.gpssurvey.collect.audiorecorder.recording.AudioRecorder;
import org.gpssurvey.collect.audiorecorder.recording.AudioRecorderFactory;
...
import static org.gpssurvey.collect.android.preferences.MetaKeys.KEY_INSTALL_ID;

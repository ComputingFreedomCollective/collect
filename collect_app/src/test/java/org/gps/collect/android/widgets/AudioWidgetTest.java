...
import org.gps.collect.android.support.TestScreenContextActivity;
import org.gps.collect.android.utilities.Appearances;
import org.gps.collect.android.widgets.support.FakeQuestionMediaManager;
import org.gps.collect.android.widgets.utilities.AudioFileRequester;
...
import org.gps.collect.android.widgets.utilities.RecordingStatusHandler;
import org.gps.collect.audioclips.Clip;
...
import static org.gps.collect.android.support.RobolectricHelpers.setupMediaPlayerDataSource;
import static org.gps.collect.android.widgets.support.QuestionWidgetHelpers.mockValueChangedListener;
import static org.gps.collect.android.widgets.support.QuestionWidgetHelpers.promptWithAnswer;
import static org.gps.collect.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnly;
import static org.gps.collect.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnlyAndAnswer;
...
public class AudioWidgetTest {
    ...
    /**
     * Currently choosing audio is locked into the {@link org.gps.collect.android.tasks.MediaLoadingTask}
     * flow and so we'd need to rip this apart to let us drop support for accepting File as data. In
     * this case it will just grab the name off the file and use {@link org.gps.collect.android.utilities.QuestionMediaManager}
